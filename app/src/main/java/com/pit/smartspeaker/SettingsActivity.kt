...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val jamendoClientIdInput = findViewById<EditText>(R.id.jamendoClientIdInput)
        ...
        jamendoClientIdInput.setText(Prefs.getJamendoClientId(this))
        ...
        saveButton.setOnClickListener {
            ...
            Prefs.setJamendoClientId(this, jamendoClientIdInput.text.toString().trim())
