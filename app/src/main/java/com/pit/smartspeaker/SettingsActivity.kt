...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val jamendoIdInput = findViewById<EditText>(R.id.jamendoIdInput)
        ...
        jamendoIdInput.setText(Prefs.getJamendoClientId(this))
        ...
        saveButton.setOnClickListener {
            ...
            Prefs.setJamendoClientId(this, jamendoIdInput.text.toString().trim())
